    ...
    while True:
        ...
        if amount.isdigit():
            ...
            if amount>0:
                ...
                print ("enter a number to perform operation:")
    return amount
...
def get_bet():
    while True:
        amount= input("how much would like to bet: ")
        if amount.isdigit():
            amount = int(amount)
            if Min_bet<= amount <=Max_bet:
                break
            else:
                print("bet amount between 100 to 1000")
        else:
                print ("enter a number to perform operation:")
    return amount
...
def get_slot_machine_spin(rows, cols, symbols):
    ...
    for _ in range(cols):
        ...
        for _ in range(rows):
            ...
            print ("current_symbols", current_symbols)
            column.append(value)
            print ("column",column)
